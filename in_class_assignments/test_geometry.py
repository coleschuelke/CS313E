...
# create objects as needed in setup or other places 
    ...
    def test_002_point_equality(self):
        ...
        self.quasi_origin = Point(0, 0, 0)
        self.assertTrue(self.origin.__eq__(self.quasi_origin) )

    #TODO! Implement this 
    def test_003_sphere_area(self):
        self.assertAlmostEqual(self.one_radius_sphere.area(), math.pi * 4 * (1 ** 2), 2)

    
    #TODO! Implement this 
    def test_004_sphere_volume(self):
        self.assertAlmostEqual(self.one_radius_sphere.volume(), (4/3) * math.pi * (self.one_radius_sphere.radius ** 3), 2) # error
    ...
    def test_006_sphere_is_inside_sphere(self):
        self.assertTrue(self.ten_radius_sphere.is_inside_sphere(self.one_radius_sphere)) # error
   ...
   #TODO! Implement this 
    def test_007_is_inside_sphere(self):
        self.assertTrue(self.ten_cube.is_inside_sphere(self.one_radius_sphere)) # error
...
# You need to implement the method is_inside_cube()
    def test_000_is_inside_cube(self):
        self.assertTrue(self.ten_cube.is_inside_cube(self.one_cube)) # error resolved
